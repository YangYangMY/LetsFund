...
class SecondFragment : Fragment(), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Determine the mode of fragment; Add or Edit mode
    ...
    override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
        if(menuItem.itemId == R.id.action_save){
            ...
            deleteAlertDialog.setPositiveButton(getString(R.string.delete)) { _, _ ->
                with(binding) {
                    val name = editTextName.text.toString()
                    val phone = editTextPhone.text.toString()
                    val newContact = Contact(name, phone)
            ...
            deleteAlertDialog.setNegativeButton(getString(R.string.cancel)) { _, _ ->
                //Do nothing
            }.create().show()
