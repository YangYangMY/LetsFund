...
import my.edu.tarc.letsfund.ui.borrower.customerservice.Faq

class FaqAdapter(private val context: Context, private val faqList: MutableList<Faq>) : BaseExpandableListAdapter() {
